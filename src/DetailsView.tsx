  ...
  const performSearch = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.get(
        "/api/serviceproviders/search?startDate=2025-04-01&endDate=2025-04-30&timeslot=16:37-16:37&housekeepingRole=NANNY&latitude=22.94739666666667&longitude=88.65848666666668"
      );
